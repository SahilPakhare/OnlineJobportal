...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="img/JobHunt.svg" type="image/x-icon">
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <a href="jobs.php" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight" style="background: #00aaff">Find A Talent</a>
                                </div>
                            </div>
                        </div>
                    </div>
